...
Thank you for your interest in contributing to **DevCraft-AI**! We're excited to have you here. Whether you're fixing a bug, adding a feature, improving documentation, or helping others, your contributions are valuable and appreciated.
...
- 🦀 **Safety First**: Use `unsafe` only when absolutely necessary
- 🦀 **Error Handling**: Use `Result` and `thiserror` for error types
- 🦀 **Documentation**: All public items must have `///` comments
- 🦀 **Performance**: Avoid unnecessary clones and allocations
...
- Test edge cases
- Located in the same file as code
...
mod tests {
    ...
    #[test]
    fn test_edge_case() {
        let result = process_data("", &ValidKey);
